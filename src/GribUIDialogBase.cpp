...
GRIBUICtrlBarBase::GRIBUICtrlBarBase(wxWindow* parent, wxWindowID id,
  ...
  if (m_bcompact) {
    ...
    m_bpAltitude =
        new wxBitmapButton(this, ID_CTRLALTITUDE, wxNullBitmap,
    ...
    m_bpNow =
        new wxBitmapButton(this, ID_BTNNOW, wxNullBitmap, wxDefaultPosition,
                           wxDefaultSize, wxBU_AUTODRAW);
    ...
    m_bpZoomToCenter =
        new wxBitmapButton(this, ID_BTNZOOMTC, wxNullBitmap, wxDefaultPosition,
                           wxDefaultSize, wxBU_AUTODRAW);
    ...
    m_bpShowCursorData =
        new wxBitmapButton(this, ID_BTNSHOWCDATA, wxNullBitmap,
                           wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
    fgSizer51->Add(m_bpShowCursorData, 0, wxALL, 1);

    fgSizer51->Add(0, 0, 1, wxEXPAND | wxLEFT | wxRIGHT, 1);
    m_bpPlay =
        new wxBitmapButton(this, ID_BTNPLAY, wxNullBitmap, wxDefaultPosition,
                           wxDefaultSize, wxBU_AUTODRAW);
  ...
  this->Connect(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(GRIBUICtrlBarBase::OnClose));
  ...
  this->Connect(wxEVT_MIDDLE_DOWN,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_MIDDLE_UP,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_RIGHT_DOWN,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_RIGHT_UP,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_MOTION,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_LEFT_DCLICK,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_MIDDLE_DCLICK,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_RIGHT_DCLICK,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Connect(wxEVT_LEAVE_WINDOW,
                wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  ...
  m_cRecordForecast->Connect(
      ...
      wxCommandEventHandler(GRIBUICtrlBarBase::OnRecordForecast), nullptr,
      this);
  m_cRecordForecast->Connect(
  ...
  m_bpShowCursorData->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(GRIBUICtrlBarBase::OnShowCursorData), nullptr,
      this);
  m_bpShowCursorData->Connect(
      wxEVT_RIGHT_DOWN, wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent),
      nullptr, this);
...
GRIBUICtrlBarBase::~GRIBUICtrlBarBase() {
  ...
  this->Disconnect(wxEVT_MIDDLE_DOWN,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_MIDDLE_UP,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_RIGHT_DOWN,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_RIGHT_UP,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_MOTION,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_LEFT_DCLICK,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_MIDDLE_DCLICK,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_RIGHT_DCLICK,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  this->Disconnect(wxEVT_LEAVE_WINDOW,
                   wxMouseEventHandler(GRIBUICtrlBarBase::OnMouseEvent));
  ...
  m_bpPrev->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(GRIBUICtrlBarBase::OnPrev),
                       nullptr, this);
  ...
  m_bpNext->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(GRIBUICtrlBarBase::OnNext),
                       nullptr, this);
...
GRIBUICDataBase::GRIBUICDataBase(wxWindow* parent, wxWindowID id,
                                 const wxString& title, const wxPoint& pos,
                                 const wxSize& size, long style)
    : wxDialog(parent, id, title, pos, size, style) {
...
CursorDataBase::CursorDataBase(wxWindow* parent, wxWindowID id,
  ...
  m_stTrackingText = new wxStaticText(this, wxID_ANY, _("MyLabel"),
  ...
  m_cbWind = new wxCheckBox(this, ID_CB_WIND, _("Wind"), wxDefaultPosition,
                            wxDefaultSize, 0);
  ...
  m_tcWindSpeedBf =
      new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxPoint(-1, -1),
  ...
  m_cbWindGust = new wxCheckBox(this, ID_CB_WIND_GUSTS, _("Wind Gust"),
                                wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbPressure = new wxCheckBox(this, ID_CB_PRESSURE, _("Pressure"),
                                wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbPrecipitation = new wxCheckBox(this, ID_CB_RAINFALL, _("Rainfall"),
                                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbCloud = new wxCheckBox(this, ID_CB_CLOUD_COVER, _("Cloud Cover"),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_fgTrackingControls->Add(m_cbCloud, 0, wxALL | wxEXPAND, 5);

  m_tcCloud = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition,
                             wxSize(70, -1), wxTE_READONLY);
  ...
  m_cbAirTemperature = new wxCheckBox(this, ID_CB_AIR_TEMP, _("Air Temp"),
                                      wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbSeaTemperature = new wxCheckBox(this, ID_CB_SEA_TEMP, _("Sea Temp"),
                                      wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbCAPE = new wxCheckBox(this, ID_CB_CAPE, _("CAPE"), wxDefaultPosition,
                            wxDefaultSize, 0);
  m_fgTrackingControls->Add(m_cbCAPE, 0, wxALL | wxEXPAND, 5);

  m_tcCAPE = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxPoint(-1, -1),
                            wxSize(70, -1), wxTE_READONLY);
  ...
  m_cbReflC = new wxCheckBox(this, ID_CB_COMP_REFL, _("Comp. Refl."),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_fgTrackingControls->Add(m_cbReflC, 0, wxALL | wxEXPAND, 5);

  m_tcReflC = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxPoint(-1, -1),
                             wxSize(70, -1), wxTE_READONLY);
  ...
  m_cbAltitude = new wxCheckBox(this, wxID_ANY, _("Altitude"),
                                wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbTemp = new wxCheckBox(this, wxID_ANY, _("Temp."), wxDefaultPosition,
                            wxDefaultSize, 0);
  ...
  m_tcTemp = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition,
  ...
  m_cbRelHumid = new wxCheckBox(this, wxID_ANY, _("Relat. Hum."),
                                wxDefaultPosition, wxDefaultSize, 0);
...
CursorDataBase::~CursorDataBase() {
  ...
  m_stTrackingText->Disconnect(
      wxEVT_LEFT_DOWN, wxMouseEventHandler(CursorDataBase::OnMouseEvent),
      nullptr, this);
  m_stTrackingText->Disconnect(
  ...
  m_stTrackingText->Disconnect(
      ...
      nullptr, this);
  m_stTrackingText->Disconnect(
      wxEVT_MIDDLE_UP, wxMouseEventHandler(CursorDataBase::OnMouseEvent),
      nullptr, this);
  m_stTrackingText->Disconnect(
      wxEVT_RIGHT_DOWN, wxMouseEventHandler(CursorDataBase::OnMouseEvent),
      nullptr, this);
  m_stTrackingText->Disconnect(
      wxEVT_RIGHT_UP, wxMouseEventHandler(CursorDataBase::OnMouseEvent),
      nullptr, this);
  m_stTrackingText->Disconnect(
  ...
  m_stTrackingText->Disconnect(
      ...
      nullptr, this);
  m_stTrackingText->Disconnect(
      wxEVT_MOUSEWHEEL, wxMouseEventHandler(CursorDataBase::OnMouseEvent),
      nullptr, this);
...
GribSettingsDialogBase::GribSettingsDialogBase(wxWindow* parent, wxWindowID id,
  ...
  m_staticText12 = new wxStaticText(m_scSetDataPanel, wxID_ANY, _("Units"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbBarbedArrows =
      new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Barbed Arrows"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cBarbedColours =
      new wxChoice(m_scSetDataPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                   m_cBarbedColoursNChoices, m_cBarbedColoursChoices, 0);
  ...
  m_cBarbArrFixSpac =
      new wxCheckBox(m_scSetDataPanel, BARBFIXSPACING, _("Fixed"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cBarbArrMinSpac =
      new wxCheckBox(m_scSetDataPanel, BARBMINSPACING, _("Minimum"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cBarbedVisibility =
      new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Always visible"),
                     wxDefaultPosition, wxDefaultSize, 0);
  m_fgBarbedData2->Add(m_cBarbedVisibility, 0, wxALL | wxEXPAND, 5);

  m_sBarbArrSpacing = new wxSpinCtrl(m_scSetDataPanel, wxID_ANY, wxEmptyString,
  ...
  m_cbIsoBars = new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("IsoBars"),
                               wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_tIsoBarSpacing = new wxStaticText(m_scSetDataPanel, wxID_ANY, _("Spacing"),
                                      wxDefaultPosition, wxDefaultSize, 0);
  m_tIsoBarSpacing->Wrap(-1);
  m_fIsoBarSpacing->Add(m_tIsoBarSpacing, 0, wxALL, 5);

  m_sIsoBarSpacing = new wxSpinCtrl(m_scSetDataPanel, wxID_ANY, wxEmptyString,
                                    wxDefaultPosition, wxDefaultSize,
  ...
  m_cbAbbrIsoBarsNumbers =
      new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Abbreviated Numbers"),
                     wxDefaultPosition, wxDefaultSize, 0);
  fgSizer15->Add(m_cbAbbrIsoBarsNumbers, 0, wxEXPAND, 5);

  fgSizer15->Add(0, 0, 1, wxEXPAND, 5);

  m_cbDirectionArrows =
      new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Direction Arrows"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxString m_cDirectionArrowFormChoices[] = {
      _("Single Arrow"), _("Double Arrow"), _("Proportional Arrow")};
  int m_cDirectionArrowFormNChoices =
      sizeof(m_cDirectionArrowFormChoices) / sizeof(wxString);
  m_cDirectionArrowForm = new wxChoice(
      m_scSetDataPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize,
      m_cDirectionArrowFormNChoices, m_cDirectionArrowFormChoices, 0);
  m_cDirectionArrowForm->SetSelection(1);
  m_fgDirArrData1->Add(m_cDirectionArrowForm, 0, wxBOTTOM | wxEXPAND | wxTOP,
                       5);
  ...
  m_cDirArrFixSpac = new wxCheckBox(m_scSetDataPanel, DIRFIXSPACING, _("Fixed"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cDirArrMinSpac =
      new wxCheckBox(m_scSetDataPanel, DIRMINSPACING, _("Minimum"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cbOverlayMap = new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("OverlayMap"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  fgSizer15->Add(m_cbOverlayMap, 0, wxBOTTOM | wxTOP, 5);

  m_tOverlayColors =
      new wxStaticText(m_scSetDataPanel, wxID_ANY, _("Color scheme"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cOverlayColors =
      new wxChoice(m_scSetDataPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                   m_cOverlayColorsNChoices, m_cOverlayColorsChoices, 0);
  m_cOverlayColors->SetSelection(0);
  fgSizer15->Add(m_cOverlayColors, 0, wxALL | wxEXPAND, 5);

  m_cbNumbers = new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Numbers"),
                               wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cNumMinSpac = new wxCheckBox(m_scSetDataPanel, NUMMINSPACING, _("Minimum"),
                                 wxDefaultPosition, wxDefaultSize, 0);
  m_fgNumData1->Add(m_cNumMinSpac, 0, wxBOTTOM | wxLEFT | wxRIGHT, 5);

  fgSizer15->Add(m_fgNumData1, 1, wxEXPAND, 0);

  m_sNumbersSpacing = new wxSpinCtrl(m_scSetDataPanel, wxID_ANY, wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     wxSP_ARROW_KEYS, 30, 100, 50);
  fgSizer15->Add(m_sNumbersSpacing, 0, wxALL, 5);

  m_cbParticles = new wxCheckBox(m_scSetDataPanel, wxID_ANY, _("Particle Map"),
                                 wxDefaultPosition, wxDefaultSize, 0);
  fgSizer15->Add(m_cbParticles, 0, wxBOTTOM | wxTOP, 5);

  m_ctParticles = new wxStaticText(m_scSetDataPanel, wxID_ANY, _("Density"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_sParticleDensity =
      new wxSlider(m_scSetDataPanel, wxID_ANY, 5, 1, 10, wxDefaultPosition,
                   wxDefaultSize, wxSL_BOTTOM | wxSL_HORIZONTAL);
#else
  m_sParticleDensity =
      new wxSlider(m_scSetDataPanel, wxID_ANY, 5, 1, 10, wxDefaultPosition,
  ...
  m_staticText24 = new wxStaticText(m_scSetDataPanel, wxID_ANY,
  ...
  m_sTransparency =
      new wxSlider(m_scSetDataPanel, wxID_ANY, 50, 0, 100, wxDefaultPosition,
                   wxSize(-1, -1), wxSL_BOTTOM | wxSL_HORIZONTAL | wxSL_LABELS);
  ...
  sbSizer121 = new wxStaticBoxSizer(
      new wxStaticBox(m_scSetPlaybackPanel, wxID_ANY, _("Playback Options")),
      wxVERTICAL);
  ...
  m_staticText4 =
      new wxStaticText(m_scSetPlaybackPanel, wxID_ANY, _("Speed Control"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText400 = new wxStaticText(m_scSetPlaybackPanel, wxID_ANY, _("Slow"),
                                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText401 = new wxStaticText(m_scSetPlaybackPanel, wxID_ANY, _("Fast"),
                                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cLoopMode = new wxCheckBox(m_scSetPlaybackPanel, wxID_ANY, _("Loop Mode"),
                               wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText26 =
      new wxStaticText(m_scSetPlaybackPanel, wxID_ANY, _("Loop Start"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  int m_cLoopStartPointNChoices =
      sizeof(m_cLoopStartPointChoices) / sizeof(wxString);
  m_cLoopStartPoint = new wxChoice(
      m_scSetPlaybackPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize,
      m_cLoopStartPointNChoices, m_cLoopStartPointChoices, 0);
  m_cLoopStartPoint->SetSelection(0);
  fgSizer481->Add(m_cLoopStartPoint, 0, wxALL | wxEXPAND, 5);

  fgSizer48->Add(fgSizer481, 0, wxALL, 5);

  m_cInterpolate = new wxCheckBox(m_scSetPlaybackPanel, wxID_ANY,
  ...
  m_tSlicesPerUpdate =
      new wxStaticText(m_scSetPlaybackPanel, wxID_ANY, _("Time Interval"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_sSlicesPerUpdate =
      new wxChoice(m_scSetPlaybackPanel, wxID_ANY, wxDefaultPosition,
                   wxDefaultSize, m_sSlicesPerUpdateChoices, 0);
  ...
  sbSizer9 = new wxStaticBoxSizer(
      new wxStaticBox(m_scSetGuiPanel, wxID_ANY, _("Dialogs Style")),
      wxVERTICAL);
  ...
  m_rbCurDataAttaWCap =
      new wxRadioButton(m_scSetGuiPanel, wxID_ANY,
                        _("Data at cursor dialog is attached to icons bar - "
                          "with a title/drag bar"),
  ...
  m_rbCurDataAttaWoCap =
      new wxRadioButton(m_scSetGuiPanel, wxID_ANY,
                        _("Data at cursor dialog is attached to icons bar - "
                          "without a title/drag bar"),
                        wxDefaultPosition, wxDefaultSize, 0);
  fgSizer47->Add(m_rbCurDataAttaWoCap, 0, wxALL, 5);

  m_rbCurDataIsolHoriz = new wxRadioButton(
      m_scSetGuiPanel, wxID_ANY,
      _("Data at cursor dialog is isolated and displayed horizontally"),
      wxDefaultPosition, wxDefaultSize, 0);
  fgSizer47->Add(m_rbCurDataIsolHoriz, 0, wxALL, 5);

  m_rbCurDataIsolVertic = new wxRadioButton(
      m_scSetGuiPanel, wxID_ANY,
      _("Data at cursor dialog is isolated and displayed vertically"),
      wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizer10 = new wxStaticBoxSizer(
      new wxStaticBox(m_scSetGuiPanel, wxID_ANY, _("Buttons Visibility")),
      wxVERTICAL);
  ...
  m_staticText44 =
      new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Attached icon bar"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText45 =
      new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Isolated icon bar"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText45->Wrap(-1);
  fgSizer52->Add(m_staticText45, 0, wxBOTTOM | wxLEFT | wxRIGHT, 5);

  m_biAltitude = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                    wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biAltitude, 0, wxALL, 2);

  wxStaticText* m_staticText46;
  m_staticText46 =
      new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Geopot. Height Choice"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText46->Wrap(-1);
  fgSizer52->Add(m_staticText46, 0, wxALL, 3);

  wxCheckBox* m_checkBox48;
  m_checkBox48 = new wxCheckBox(m_scSetGuiPanel, AC0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox48, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox49;
  m_checkBox49 = new wxCheckBox(m_scSetGuiPanel, AC1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox49, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biNow = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                               wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biNow, 0, wxALL, 3);

  wxStaticText* m_staticText47;
  m_staticText47 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Now"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText47->Wrap(-1);
  fgSizer52->Add(m_staticText47, 0, wxALL, 3);

  wxCheckBox* m_checkBox50;
  m_checkBox50 = new wxCheckBox(m_scSetGuiPanel, NW0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox50, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox51;
  m_checkBox51 = new wxCheckBox(m_scSetGuiPanel, NW1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox51, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biZoomToCenter = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                        wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biZoomToCenter, 0, wxALL, 3);

  wxStaticText* m_staticText48;
  m_staticText48 =
      new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Zoom to Center"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText48->Wrap(-1);
  fgSizer52->Add(m_staticText48, 0, wxALL, 3);

  wxCheckBox* m_checkBox52;
  m_checkBox52 = new wxCheckBox(m_scSetGuiPanel, ZC0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox52, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox53;
  m_checkBox53 = new wxCheckBox(m_scSetGuiPanel, ZC1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText49 =
      new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Show Cursor Data"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText49->Wrap(-1);
  fgSizer52->Add(m_staticText49, 0, wxALL, 3);

  wxCheckBox* m_checkBox54;
  m_checkBox54 = new wxCheckBox(m_scSetGuiPanel, SCD0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox54, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox55;
  m_checkBox55 = new wxCheckBox(m_scSetGuiPanel, SCD1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox55, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biPlay = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biPlay, 0, wxALL, 3);

  wxStaticText* m_staticText50;
  m_staticText50 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Playback"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText50->Wrap(-1);
  fgSizer52->Add(m_staticText50, 0, wxALL, 3);

  wxCheckBox* m_checkBox56;
  m_checkBox56 = new wxCheckBox(m_scSetGuiPanel, PB0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox56, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox57;
  m_checkBox57 = new wxCheckBox(m_scSetGuiPanel, PB1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox57, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biTimeSlider = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biTimeSlider, 0, wxALL, 3);

  wxStaticText* m_staticText51;
  m_staticText51 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Time Slider"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText51->Wrap(-1);
  fgSizer52->Add(m_staticText51, 0, wxALL, 3);

  wxCheckBox* m_checkBox58;
  m_checkBox58 = new wxCheckBox(m_scSetGuiPanel, TL0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox58, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox59;
  m_checkBox59 = new wxCheckBox(m_scSetGuiPanel, TL1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox59, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biOpenFile = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                    wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biOpenFile, 0, wxALL, 3);

  wxStaticText* m_staticText52;
  m_staticText52 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Open File"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText52->Wrap(-1);
  fgSizer52->Add(m_staticText52, 0, wxALL, 3);

  wxCheckBox* m_checkBox60;
  m_checkBox60 = new wxCheckBox(m_scSetGuiPanel, OF0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox60, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox61;
  m_checkBox61 = new wxCheckBox(m_scSetGuiPanel, OF1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox61, 0, wxALIGN_CENTER_HORIZONTAL, 5);

  m_biSettings = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                    wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biSettings, 0, wxALL, 3);

  wxStaticText* m_staticText53;
  m_staticText53 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Settings"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText53->Wrap(-1);
  fgSizer52->Add(m_staticText53, 0, wxALL, 3);

  wxCheckBox* m_checkBox62;
  m_checkBox62 = new wxCheckBox(m_scSetGuiPanel, STS0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox62, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox63;
  m_checkBox63 = new wxCheckBox(m_scSetGuiPanel, STS1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox63, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  m_biRequest = new wxStaticBitmap(m_scSetGuiPanel, wxID_ANY, wxNullBitmap,
                                   wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_biRequest, 0, wxALL, 3);

  wxStaticText* m_staticText54;
  m_staticText54 = new wxStaticText(m_scSetGuiPanel, wxID_ANY, _("Request"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText54->Wrap(-1);
  fgSizer52->Add(m_staticText54, 0, wxALL, 3);

  wxCheckBox* m_checkBox64;
  m_checkBox64 = new wxCheckBox(m_scSetGuiPanel, RQ0, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  fgSizer52->Add(m_checkBox64, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 3);

  wxCheckBox* m_checkBox65;
  m_checkBox65 = new wxCheckBox(m_scSetGuiPanel, RQ1, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_nSettingsBook->Connect(
      ...
      wxNotebookEventHandler(GribSettingsDialogBase::OnPageChange), nullptr,
      this);
  m_cDataType->Connect(
      wxEVT_COMMAND_CHOICE_SELECTED,
  ...
  m_cDataUnits->Connect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(GribSettingsDialogBase::OnUnitChange), nullptr,
      this);
  m_cBarbArrFixSpac->Connect(
      wxEVT_COMMAND_CHECKBOX_CLICKED,
      wxCommandEventHandler(GribSettingsDialogBase::OnSpacingModeChange),
      nullptr, this);
  ...
  m_sTransparency->Connect(
      wxEVT_SCROLL_TOP,
      wxScrollEventHandler(GribSettingsDialogBase::OnTransparencyChange),
      nullptr, this);
  m_sTransparency->Connect(
      wxEVT_SCROLL_BOTTOM,
      wxScrollEventHandler(GribSettingsDialogBase::OnTransparencyChange),
  ...
  m_cLoopMode->Connect(
      wxEVT_COMMAND_CHECKBOX_CLICKED,
      wxCommandEventHandler(GribSettingsDialogBase::OnIntepolateChange),
      nullptr, this);
...
GribPreferencesDialogBase::GribPreferencesDialogBase(
  ...
  wxStaticText* labelBox =
      new wxStaticText(this, wxID_ANY, _("GRIB PlugIn Preferences"),
                       wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE);
  labelSizer->Add(labelBox, 1, wxEXPAND, 0);

  wxScrolledWindow* itemScrollWin = new wxScrolledWindow(
      this, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxVSCROLL);
  ...
  wxStaticBoxSizer* sbSizer9;
  sbSizer9 = new wxStaticBoxSizer(
      new wxStaticBox(itemScrollWin, wxID_ANY, _("General Options")),
      wxVERTICAL);
  itemBoxSizer2->Add(sbSizer9, 1, wxEXPAND, 5);

  m_cbUseHiDef =
      new wxCheckBox(itemScrollWin, wxID_ANY, _("Use High Definition Graphics"),
                     wxDefaultPosition, wxDefaultSize, 0);
  sbSizer9->Add(m_cbUseHiDef, 0, wxALL, 5);

  m_cbUseGradualColors =
      new wxCheckBox(itemScrollWin, wxID_ANY, _("Use Gradual Colors"),
                     wxDefaultPosition, wxDefaultSize, 0);
  sbSizer9->Add(m_cbUseGradualColors, 0, wxALL, 5);

  m_cbCopyFirstCumulativeRecord = new wxCheckBox(
      itemScrollWin, wxID_ANY, _("Copy First Cumulative Missing Record"),
      wxDefaultPosition, wxDefaultSize, 0);
  sbSizer9->Add(m_cbCopyFirstCumulativeRecord, 0, wxALL, 5);

  m_cbCopyMissingWaveRecord =
      new wxCheckBox(itemScrollWin, wxID_ANY, _("Copy Missing Wave Records"),
                     wxDefaultPosition, wxDefaultSize, 0);
  sbSizer9->Add(m_cbCopyMissingWaveRecord, 0, wxALL, 5);

  m_cbDrawBarbedArrowHead =
      new wxCheckBox(itemScrollWin, wxID_ANY, _("Draw Barbed Arrows Head"),
                     wxDefaultPosition, wxDefaultSize, 0);
  sbSizer9->Add(m_cbDrawBarbedArrowHead, 0, wxALL, 5);

  m_cZoomToCenterAtInit = new wxCheckBox(itemScrollWin, wxID_ANY,
                                         _("Zoom to file center when opened"),
                                         wxDefaultPosition, wxDefaultSize, 0);
  ...
  int m_rbLoadOptionsNChoices =
      sizeof(m_rbLoadOptionsChoices) / sizeof(wxString);
  m_rbLoadOptions =
      new wxRadioBox(itemScrollWin, wxID_ANY, _("Load File Options"),
                     wxDefaultPosition, wxDefaultSize, m_rbLoadOptionsNChoices,
                     m_rbLoadOptionsChoices, 1, wxRA_SPECIFY_COLS);
  m_rbLoadOptions->SetSelection(0);
  ...
  int m_rbStartOptionsNChoices =
      sizeof(m_rbStartOptionsChoices) / sizeof(wxString);
  m_rbStartOptions =
      new wxRadioBox(itemScrollWin, wxID_ANY, _("Start Options"),
                     wxDefaultPosition, wxDefaultSize, m_rbStartOptionsNChoices,
...
void GribRequestSettingBase::createEmailPanel() {
  ...
  sbSizer7 = new wxStaticBoxSizer(
      new wxStaticBox(m_sScrolledDialog, wxID_ANY, _("Profile")), wxVERTICAL);
  ...
  m_staticText25 =
      new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Sender eMail Address"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText25->Wrap(-1);
  m_pSenderSizer->Add(m_staticText25, 0, wxALL, 5);

  m_pSenderAddress = new wxTextCtrl(m_sScrolledDialog, wxID_ANY, wxEmptyString,
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_pSenderSizer->Add(m_pSenderAddress, 0, wxALL | wxEXPAND, 5);

  wxStaticLine* m_staticline4;
  m_staticline4 =
      new wxStaticLine(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
  ...
  m_staticText15 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Mail To "),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText15->Wrap(-1);
  fgSizer33->Add(m_staticText15, 0, wxEXPAND | wxLEFT | wxRIGHT | wxTOP, 5);

  wxArrayString m_pMailToChoices;
  m_pMailTo = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                           wxDefaultSize, m_pMailToChoices, 0);
  m_pMailTo->SetSelection(0);
  fgSizer33->Add(m_pMailTo, 0, wxALL, 5);

  wxStaticText* m_staticText16;
  m_staticText16 =
      new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Forecast Model "),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText16->Wrap(-1);
  fgSizer33->Add(m_staticText16, 0, wxALL | wxEXPAND | wxLEFT | wxRIGHT | wxTOP,
                 5);

  wxArrayString m_pModelChoices;
  m_pModel = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                          wxDefaultSize, m_pModelChoices, 0);
  ...
  m_cMovingGribEnabled =
      new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("Moving Grib"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText27 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Speed"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText27->Wrap(-1);
  m_fgMovingParams->Add(m_staticText27, 0, wxALL, 5);

  m_sMovingSpeed = new wxSpinCtrl(m_sScrolledDialog, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize,
                                  wxSP_ARROW_KEYS, 1, 30, 1);
  m_fgMovingParams->Add(m_sMovingSpeed, 0, wxALL, 5);

  wxStaticText* m_sSpeedUnit;
  m_sSpeedUnit = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Kts"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  m_sSpeedUnit->Wrap(-1);
  m_fgMovingParams->Add(m_sSpeedUnit, 0, wxBOTTOM | wxEXPAND | wxRIGHT | wxTOP,
                        5);

  wxStaticText* m_staticText29;
  m_staticText29 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Course"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText29->Wrap(-1);
  m_fgMovingParams->Add(m_staticText29, 0, wxALL, 5);

  m_sMovingCourse = new wxSpinCtrl(m_sScrolledDialog, wxID_ANY, wxEmptyString,
                                   wxDefaultPosition, wxDefaultSize,
                                   wxSP_ARROW_KEYS, 1, 360, 1);
  m_fgMovingParams->Add(m_sMovingCourse, 0, wxALL, 5);

  m_sCourseUnit = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Deg"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  m_sCourseUnit->Wrap(-1);
  m_fgMovingParams->Add(m_sCourseUnit, 0, wxBOTTOM | wxEXPAND | wxRIGHT | wxTOP,
                        5);
  ...
  m_tLogin = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("zyGrib Login"),
                              wxDefaultPosition, wxDefaultSize, 0);
  m_tLogin->Wrap(-1);
  m_fgLog->Add(m_tLogin, 0, wxALL, 5);

  m_pLogin = new wxTextCtrl(m_sScrolledDialog, wxID_ANY, wxEmptyString,
                            wxDefaultPosition, wxDefaultSize, 0);
  m_fgLog->Add(m_pLogin, 0, wxALL, 5);

  wxStaticText* m_tCode;
  m_tCode = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("zyGrib Code"),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_tCode->Wrap(-1);
  m_fgLog->Add(m_tCode, 0, wxALL, 5);

  m_pCode = new wxTextCtrl(m_sScrolledDialog, wxID_ANY, wxEmptyString,
                           wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText17 =
      new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Resolution"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText17->Wrap(-1);
  fgSizer13->Add(m_staticText17, 0, wxALL, 5);

  wxArrayString m_pResolutionChoices;
  m_pResolution = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                               wxDefaultSize, m_pResolutionChoices, 0);
  m_pResolution->SetSelection(0);
  fgSizer13->Add(m_pResolution, 0, wxALL, 1);

  m_tResUnit = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Deg"),
                                wxDefaultPosition, wxDefaultSize, 0);
  m_tResUnit->Wrap(-1);
  fgSizer13->Add(m_tResUnit, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);

  wxStaticText* m_staticText18;
  m_staticText18 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Interval"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticText18->Wrap(-1);
  fgSizer13->Add(m_staticText18, 0, wxALL, 5);

  wxArrayString m_pIntervalChoices;
  m_pInterval = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                             wxDefaultSize, m_pIntervalChoices, 0);
  m_pInterval->SetSelection(0);
  fgSizer13->Add(m_pInterval, 0, wxALL, 1);

  wxStaticText* m_staticText20;
  m_staticText20 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Hours"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText19 =
      new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Time Range"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_staticText19->Wrap(-1);
  fgSizer13->Add(m_staticText19, 0, wxALL, 5);

  wxArrayString m_pTimeRangeChoices;
  m_pTimeRange = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                              wxDefaultSize, m_pTimeRangeChoices, 0);
  m_pTimeRange->SetSelection(0);
  fgSizer13->Add(m_pTimeRange, 0, wxALL, 1);

  m_staticText21 = new wxStaticText(m_sScrolledDialog, wxID_ANY, _("Days"),
                                    wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizer8 = new wxStaticBoxSizer(
      new wxStaticBox(m_sScrolledDialog, wxID_ANY, _("Data Selection")),
      wxVERTICAL);
  ...
  m_pWModel = new wxChoice(m_sScrolledDialog, wxID_ANY, wxDefaultPosition,
                           wxDefaultSize, m_pWModelChoices, 0);
  ...
  m_pAltitudeData =
      new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("Geopotential Height"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_p850hpa = new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("850 hPa"),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_fgAltitudeData->Add(m_p850hpa, 0,
                        wxALL | wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN, 5);

  m_p700hpa = new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("700 hPa"),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_fgAltitudeData->Add(m_p700hpa, 0,
                        wxALL | wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN, 5);

  m_p500hpa = new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("500 hPa"),
                             wxDefaultPosition, wxDefaultSize, 0);
  m_fgAltitudeData->Add(m_p500hpa, 0, wxALL | wxEXPAND, 5);

  m_p300hpa = new wxCheckBox(m_sScrolledDialog, wxID_ANY, _("300 hPa"),
                             wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizer6 = new wxStaticBoxSizer(
      new wxStaticBox(m_sScrolledDialog, wxID_ANY, _("Mail")), wxVERTICAL);
...
GribRequestSettingBase::GribRequestSettingBase(GRIBUICtrlBarBase* parent,
  ...
  m_SourcesTreeCtrl1->Connect(
      ...
      wxTreeEventHandler(GribRequestSettingBase::OnLocalTreeSelChanged),
      nullptr, this);
  m_buttonUpdateCatalog->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(GribRequestSettingBase::OnUpdateLocalCatalog),
      nullptr, this);
  ...
  m_cMovingGribEnabled->Connect(
      wxEVT_COMMAND_CHECKBOX_CLICKED,
      wxCommandEventHandler(GribRequestSettingBase::OnMovingClick), nullptr,
      this);
  m_sMovingSpeed->Connect(
      wxEVT_COMMAND_SPINCTRL_UPDATED,
      wxSpinEventHandler(GribRequestSettingBase::OnAnySpinChange), nullptr,
      this);
...
GribRequestSettingBase::~GribRequestSettingBase() {
  ...
  m_pMailTo->Disconnect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(GribRequestSettingBase::OnTopChange), nullptr,
      this);
  m_pModel->Disconnect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(GribRequestSettingBase::OnTopChange), nullptr,
...
GRIBTableBase::GRIBTableBase(wxWindow* parent, wxWindowID id,
  ...
  m_pPositionText = new wxStaticText(this, wxID_ANY, _("Data at Position:"),
                                     wxDefaultPosition, wxDefaultSize, 0);
  m_pPositionText->Wrap(-1);
  fgSizer19->Add(m_pPositionText, 0, wxALL | wxEXPAND, 5);

  m_pCursorPosition = new wxStaticText(this, wxID_ANY, wxEmptyString,
                                       wxDefaultPosition, wxDefaultSize, 0);
