...
//    Windy wave palette: exact RGB from windy.com, extended to setting max (30m)
static ColorMap GenericMap[] = {
    {0, _T("#9FB9BF")},    {0.5, _T("#309DB9")},  {1, _T("#30628D")},
    {1.5, _T("#3868BF")},  {2, _T("#393C8E")},    {2.5, _T("#BB5ABF")},
    {3, _T("#9A3097")},    {4, _T("#853030")},    {5, _T("#BF335F")},
    {7, _T("#BF6757")},    {10, _T("#BFBFBF")},   {12, _T("#9A7F9B")},
    {30, _T("#9A7F9B")}};

//    Windy wind palette (m/s) — truncated to match setting max (40 m/s).
//    Palette-normalized cmax must match setting max so a given wind value
//    lands on the correct color.
static ColorMap WindMap[] = {
    {0, _T("#6271B7")},   {1, _T("#39619F")},   {3, _T("#4A94A9")},
    {5, _T("#4D8D7B")},   {7, _T("#53A553")},   {9, _T("#359F35")},
    {11, _T("#A79D51")},  {13, _T("#9F7F3A")},  {15, _T("#A16C5C")},
    {17, _T("#813A4E")},  {19, _T("#AF5088")},  {21, _T("#754A93")},
    {24, _T("#6D61A3")},  {27, _T("#44698D")},  {29, _T("#5C9098")},
    {36, _T("#7D44A5")},  {40, _T("#E7D7D7")}};

//    Windy air temperature palette, mapped to °C offset from setting min (-40°C).
//    palette_val = celsius_temp - (-40), range 0..90 matches max-min.
static ColorMap AirTempMap[] = {
    {0, _T("#A24691")},  {15, _T("#8F59A9")}, {25, _T("#9DDBD9")},
    {32, _T("#6ABFB5")}, {36, _T("#64A6BD")}, {40, _T("#5D85C6")},
    {41, _T("#447D63")}, {50, _T("#809318")}, {61, _T("#F3B704")},
    {70, _T("#E85319")}, {87, _T("#470E00")}, {90, _T("#470E00")}};
...
//    Windy rain palette (mm) — extended to setting max (80mm)
static ColorMap PrecipitationMap[] = {
    {0, _T("#6F6F6F")},  {0.6, _T("#3C74A0")}, {6, _T("#3BA1A1")},
    {8, _T("#3BA13D")},  {10, _T("#82A13B")},  {15, _T("#A1A13B")},
    {20, _T("#A13B3B")}, {31, _T("#A13BA1")},  {50, _T("#A8A8A8")},
    {80, _T("#A8A8A8")}};

//    Windy cloud cover palette (%)
static ColorMap CloudMap[] = {
    {0, _T("#928246")},  {10, _T("#847746")}, {50, _T("#747474")},
    {95, _T("#ABB4B3")}, {98, _T("#C6C9C9")}, {100, _T("#D5D5CD")}};
...
//    Windy CAPE palette (J/kg), truncated at setting max (3500).
//    Last entry interpolated between Windy's 2500 and 5001 values.
static ColorMap CAPEMap[] = {
    {0, _T("#6E6E6E")},    {350, _T("#6E6E6E")},  {400, _T("#5D5F7F")},
    {500, _T("#256291")},  {800, _T("#25A525")},  {1500, _T("#A3A137")},
    {2000, _T("#9B703F")}, {2500, _T("#A23737")}, {3500, _T("#9E3C5D")}};

//    Windy-exact wind palette: light cyan → teal → green → yellow → red → pink → violet
static ColorMap WindyMap[] = {
    {0, _T("#B8D8E8")},  {3, _T("#80C8D8")},  {6, _T("#40B8C8")},
    {9, _T("#20B090")},  {12, _T("#60C060")}, {15, _T("#B0D040")},
    {18, _T("#E8D830")}, {21, _T("#E0B028")}, {24, _T("#D88820")},
    {27, _T("#D06018")}, {30, _T("#C84018")}, {33, _T("#B82028")},
    {36, _T("#A82048")}, {39, _T("#982068")}, {42, _T("#882088")},
    {45, _T("#7828A0")}, {48, _T("#6830B0")}, {51, _T("#5838B8")},
    {54, _T("#4838B8")}, {57, _T("#3838B0")}, {60, _T("#2838A0")},
    {63, _T("#483898")}, {66, _T("#7040A0")}, {69, _T("#A050B0")},
    {72, _T("#C860B8")}, {75, _T("#E078C0")}, {78, _T("#E890C8")},
    {81, _T("#F0A8D0")}, {84, _T("#F0B8D0")}, {87, _T("#F0C8D0")},
    {90, _T("#F0D8D0")}, {93, _T("#F0E0D0")}, {96, _T("#F0E8D0")},
    {99, _T("#F0F0D0")}};
